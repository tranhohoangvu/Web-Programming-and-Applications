            ...
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h3>Thêm Sản Phẩm</h3>
                        <a href="<?php echo e(route('account.sanpham')); ?>" class="btn btn-light">Back</a>
                    </div>
                    <div class="card-body">
                        <form action="<?php echo e(route('account.store')); ?>" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" name="loaisanpham" id="loaisanpham" class="form-control" placeholder="Nhập loại sản phẩm">
                            </div>
                            <div class="form-group mb-3">
...
<?php /**PATH D:\LTWVUD\store.com - Backup - 19.05 - 12h24\store.com - Backup - 19.05 - 12h24\resources\views/backend/account/sanpham_create.blade.php ENDPATH**/ ?>