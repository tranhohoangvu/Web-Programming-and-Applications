...
<body class="gray-bg">
    ...
    <div class="middle-box text-center loginscreen animated fadeInDown">
        <div>
            ...
            <p>(--Quản trị viên cửa hàng An Khang Store--)</p>
            <p></p>
                ...
                <div class = "inbox-content"> 
                    ...
                    <div class="form-group">
                        <input type="text" name = "email" class="form-control" placeholder="Email" value="<?php echo e(old('email')); ?>" > <!--Giữ lại email cũ-->
...
<?php /**PATH C:\Users\USER\OneDrive - IT\Desktop\Học Tập\HK2_2023-2024\Lập Trình Web\final-web\store.com\store.com\resources\views/backend/auth/login.blade.php ENDPATH**/ ?>