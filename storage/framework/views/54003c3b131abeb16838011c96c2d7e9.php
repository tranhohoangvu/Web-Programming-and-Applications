...
<?php $__env->startSection('content'); ?>
    <div class="container">
        ...
        <form action="<?php echo e(route('account.user-store')); ?>" method="POST">
            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="form-group">
                ...
                <input type="hidden" name="vaitro" id="vaitro-hidden">
                <select name="vaitro" id="vaitro-select" class="form-control">
...
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                <span class="error-message">*<?php echo e($errors->first('vaitro')); ?></span>
                <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?>
...
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                <span class="error-message">*<?php echo e($errors->first('trangthaikhoa')); ?></span>
                <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?>
...
<?php $__env->startSection('scripts'); ?>
    ...
    <script>
        document.getElementById('vaitro-select').addEventListener('change', function() {
            document.getElementById('vaitro-hidden').value = this.value;
        });
        document.querySelector('form').addEventListener('submit', function() {
            document.getElementById('vaitro-hidden').value = document.getElementById('vaitro-select').value;
        });

    </script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\store_management\store.com\resources\views/backend/account/user_create.blade.php ENDPATH**/ ?>