    ...
    <div class="createOrder container my-5 col-sm-6">
        ...
        <form action="<?php echo e(route('place.order')); ?>" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="text" id="hotendaydu" name="hotendaydu" class="form-control" value="<?php echo e(auth()->user()->employee->hotendaydu); ?>" readonly>
                <input type="hidden" id="TenNhanVien" name="TenNhanVien" value="<?php echo e(auth()->user()->employee->id); ?>">
            </div>
...
</html><?php /**PATH C:\Users\lpn31\OneDrive - IT\Desktop\Cuoi_ki\store.com - Backup - 23.05 - 13h37\resources\views/order/new_order_form.blade.php ENDPATH**/ ?>