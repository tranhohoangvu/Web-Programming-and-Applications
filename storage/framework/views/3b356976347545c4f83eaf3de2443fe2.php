            ...
            <form action="<?php echo e(route('order.history')); ?>" method="POST">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-6">
                        ...
                        <input type="text" id="GioDatHang" name="GioDatHang" class="form-control" value="<?php echo e($order->GioDatHang); ?>" readonly>
                    </div>
                </div>  
                <div class="mb-3">
...
</html><?php /**PATH C:\Users\ASUS\Downloads\store.com - Backup - 19.05 - 12h24\store.com - Backup - 19.05 - 12h24\resources\views/order/confirm_order.blade.php ENDPATH**/ ?>