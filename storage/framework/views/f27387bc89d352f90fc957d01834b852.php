...
<body>
    ...
    <header class="custom-header-bg">
        <nav class="navbar navbar-expand-lg navbar-light">
            <div class="container my-3">   
                <div>
                    <a class="navbar-brand fw-bold fs-2 text-light" href="<?php echo e(route('report.generate')); ?>">ANKHANG STORE</a>
                </div>
            </div>
        </nav>
    </header>
    ...
    <div class="container mt-4">
        <h1 class="text-center">BÁO CÁO VÀ PHÂN TÍCH</h1>
        <div>
            <h5 class="text-center mb-4">Trong khoảng thời gian từ <?php echo e(\Carbon\Carbon::parse($startDate)->format('d/m/Y')); ?> đến <?php echo e(\Carbon\Carbon::parse($endDate)->format('d/m/Y')); ?></h5>
        </div>
        <div class="row text-center">
            ...
            <div class="col-6">
                <div>
                    ...
                    <span><?php echo e(number_format($tongTien, 0, ',', '.')); ?> VND</span>
                </div>
            </div>
        </div>
...
<?php /**PATH C:\xampp\htdocs\store.com\resources\views/report/report_index.blade.php ENDPATH**/ ?>