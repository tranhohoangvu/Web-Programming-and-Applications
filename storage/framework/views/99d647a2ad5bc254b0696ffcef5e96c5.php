        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p class="text-danger bottom-3 w-100 display-4">Tài khoản <?php echo e(auth()->user()->employee->hotendaydu); ?> là nhân viên mới không được đăng nhập vào đây.</p>
...
<?php /**PATH C:\Users\Hoang Vu\Downloads\N23+25\N23+25\store.com\store.com\resources\views/backend/modal/error_new_employee.blade.php ENDPATH**/ ?>