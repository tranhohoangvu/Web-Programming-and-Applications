...
<body>
    ...
    <header class="custom-header-bg">
        <nav class="navbar navbar-expand-lg navbar-light">
            <div class="container my-3">   
                <div>
                    <a class="navbar-brand fw-bold fs-2 text-light" href="<?php echo e(route('order.history')); ?>">ANKHANG STORE</a>
                    <br>
    ...
    <div class="container border p-3 my-4 col-lg-6">
        ...
        <a href="<?php echo e(route('order.history')); ?>" class="btn btn-secondary float-end">Quay lại</a>
    </div>
...
</html><?php /**PATH D:\LTWVUD\store.com - Backup - 19.05 - 12h24\store.com - Backup - 19.05 - 12h24\resources\views/order/order_detail.blade.php ENDPATH**/ ?>