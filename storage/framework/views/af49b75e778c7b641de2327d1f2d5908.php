                ...
                <div class="col-md-8 d-flex justify-content-end align-items-center">
                    <nav>
                        <ul class="nav d-none d-md-flex">
                            ...
                            <li class="nav-item">
                                <a class="nav-link text-white" href="<?php echo e(route('account.customer')); ?>" >Quản lí khách hàng</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link text-white" href="<?php echo e(route('manage_customer')); ?>" id="manageCustomer">Quản lí đơn hàng</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link text-white" href="http://127.0.0.1:8000/account/sanpham">Quản lí sản phẩm</a>
                            </li>
...
<?php /**PATH C:\Users\ASUS\Downloads\store.com - Backup - 19.05 - 12h24\store.com - Backup - 19.05 - 12h24\resources\views/backend/dashboard/nhanvien.blade.php ENDPATH**/ ?>