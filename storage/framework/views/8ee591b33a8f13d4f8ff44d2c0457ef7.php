                    ...
                    <div class="card-body">
                        <form action="<?php echo e(route('account.update', ['id' => $sanpham->id])); ?>" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" name="soLuongNhap" id="soLuongNhap" value="<?php echo e($sanpham->soLuongNhap); ?>" class="form-control" placeholder="Nhập số lượng nhập">
                            </div>
                            <div class="form-group mb-3">
                                <label for="soLuongConLai">Số Lượng Còn Lại:</label>
                                <input type="text" name="soLuongConLai" id="soLuongConLai" value="<?php echo e($sanpham->soLuongConLai); ?>" class="form-control" placeholder="Nhập số lượng nhập">
                            </div>
                            <div class="form-group mb-3">
                            ...
                            <!-- <div class="form-group mb-3">
                                ...
                                <input type="checkbox" name="trangthai" id="trangthai" value="1" <?php echo e($sanpham->trangthai ? 'checked' : ''); ?>>
...
<?php /**PATH C:\xampp\htdocs\store.com\resources\views/backend/account/sanpham_edit.blade.php ENDPATH**/ ?>