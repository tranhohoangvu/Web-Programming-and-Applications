...
<body>
    ...
    <a href="<?php echo e(route('account.user_profile', ['id' => auth()->user()->id])); ?>" class="text-white">
        ...
        <?php if($employee && $employee->avatar): ?>
            <img src="<?php echo e(asset('uploads/employees/' . $employee->avatar)); ?>" width="70px" height="70px" alt="avatar" class="avatar">
        <?php else: ?>
            <img src="<?php echo e(asset('img/AnhMacDinhKhongXoa.jpg')); ?>" width="70px" height="70px" alt="Avatar">
        <?php endif; ?>
        <p class="user_name"><?php echo e(auth()->user()->employee->hotendaydu); ?></p>
    </a>
<?php endif; ?>
                        ...
                        <ul class="nav d-none d-md-flex">
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="BaoCao">
                                    <li><a class="dropdown-item" href="<?php echo e(route('report.report.generate')); ?>">Báo cáo và phân tích</a></li>
                                    <li><a class="dropdown-item" href="<?php echo e(route('report.report.profit.generate')); ?>">Tổng lợi nhuận</a></li>
                                </ul>
                            </li>
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="BaoCao">
                                    <li><a class="nav-link" href="http://127.0.0.1:8000/account/user-show">Quản lí người dùng</a></li>
...
</html><?php /**PATH C:\Users\Hoang Vu\Downloads\N23+25\N23+25\store.com\store.com\resources\views/backend/dashboard/index.blade.php ENDPATH**/ ?>