        ...
        <div class="row justify-content-center">
            <div class="col-md-6">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="GET" action="<?php echo e(route('report.profit')); ?>" id="profitForm">
                            ...
                            <div class="form-group" id="choose-year" style="display: none;">
                                <div class="row">
                                    <div class="my-2">
                                        ...
                                        <input type="number" class="form-control" id="year" name="year" min="1900" max="2100" step="1" value="<?php echo e(date('Y')); ?>">
                                    </div>
                                </div>
                            </div>
...
<?php /**PATH C:\Users\Hoang Vu\Downloads\N23+25\N23+25\store.com\store.com\resources\views/report/report_profit_generate.blade.php ENDPATH**/ ?>