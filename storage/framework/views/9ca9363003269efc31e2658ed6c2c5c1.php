                        ...
                        <form action="<?php echo e(route('profile.update', ['id' => $user->id])); ?>" method="POST" id="edit-profile-form">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <?php if(auth()->user()->vaitro == 1): ?>
                                    <input type="text" class="form-control" name="username" value="<?php echo e($user->employee->diachi); ?>" >
                                    <?php else: ?>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <?php if(auth()->user()->vaitro==1): ?>
                                        <input type="date" class="form-control" name="ngaysinh" value="<?php echo e(\Carbon\Carbon::parse($user->employee->ngaysinh)->format('Y-m-d')); ?>" >
                                    <?php else: ?>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <?php if(auth()->user()->vaitro==1): ?>
                                        <input type="date" class="form-control" name="ngayvaolam" value="<?php echo e(\Carbon\Carbon::parse($user->employee->ngayvaolam)->format('Y-m-d')); ?>" >
                                    <?php else: ?>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <?php if(auth()->user()->vaitro==1): ?>
                                    <input type="text" class="form-control" name="trinhdo" value="<?php echo e($user->employee->trinhdo); ?>" >
                                    <?php else: ?>
...
<?php /**PATH C:\Users\lpn31\OneDrive - IT\Desktop\Cuoi_ki\store.com - Backup - 23.05 - 13h37\resources\views/backend/account/user_profile.blade.php ENDPATH**/ ?>