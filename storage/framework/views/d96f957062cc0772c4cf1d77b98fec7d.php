                ...
                <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <tr>
                     ...
                     <td>   
                            ...
                            <form class="user_lock" action="<?php echo e(route('account.user-lock', ['id' => $user->id])); ?>" method="POST">
                                <?php echo csrf_field(); ?>
                            ...
                            <?php if($user->trangthaikhoa): ?>
                                <form class="user_unlock" action="<?php echo e(route('account.user-unlock', ['id' => $user->id])); ?>" method="POST" style="display:inline;">
                                    <?php echo csrf_field(); ?>
                                    <?php echo method_field('PUT'); ?>
                                    <button type="submit" class="btn btn-success btn-circle" onclick="return confirm('Bạn có chắc chắn muốn mở khóa tài khoản này?')">Mở Khóa</button>
                                </form>
                            <?php endif; ?>
                        </td>
                        </td>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\lpn31\OneDrive - IT\Desktop\Cuoi_ki\store.com - Backup - 23.05 - 13h37\resources\views/backend/account/user_show.blade.php ENDPATH**/ ?>