            ...
            <form action="{{ route('order.history') }}" method="POST">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-6">
                        ...
                        <input type="text" id="tongtien" name="tongtien" class="form-control" value="{{ number_format($order->tongtien ?? 0, 0, ',', '.') }}" readonly>
                    </div>
                </div>  
                <div class="row mb-3">
                    <div class="col-sm-6">
                ...
                <div class="text-center mt-4">
                    <a href="{{ route('cancel.order', ['id' => $order->id]) }}" class="btn btn-danger">Hủy đặt hàng</a>
