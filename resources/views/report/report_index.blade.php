...
<body>
    ...
    <header class="custom-header-bg">
        <nav class="navbar navbar-expand-lg navbar-light">
            <div class="container my-3">   
                <div>
                    <a class="navbar-brand fw-bold fs-2 text-light" href="{{ route('report.generate') }}">ANKHANG STORE</a>
                </div>
            </div>
        </nav>
    </header>
    ...
    <div class="container mt-4">
        ...
        <div>
            <h5 class="text-center mb-4">Trong khoảng thời gian từ {{ \Carbon\Carbon::parse($startDate)->format('d/m/Y') }} đến {{ \Carbon\Carbon::parse($endDate)->format('d/m/Y') }}</h5>
        </div>
