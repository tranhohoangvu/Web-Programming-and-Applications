...
<body>
    ...
    <a href="{{ route('account.user_profile', ['id' => auth()->user()->id]) }}" class="text-white">
        ...
        @endif
        <p class="user_name">{{ auth()->user()->employee->hotendaydu }}</p>
    </a>
@endauth
                        ...
                        <ul class="nav d-none d-md-flex">
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="BaoCao">
                                    ...
                                    <li><a class="dropdown-item" href="{{ route('report.report.profit.generate') }}">Tổng lợi nhuận</a></li>
                                </ul>
                            </li>
                            <li class="nav-item dropdown">
                ...
                <div id="imageCarousel" class="carousel slide" data-bs-ride="carousel">
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img src="{{ asset('img/ak1.jpg') }}" alt="Cửa hàng">
                        </div>
                        <div class="carousel-item">
                            <img src="{{ asset('img/ak2.jpg') }}" alt="Cửa hàng">
                        </div>
                        <div class="carousel-item">
                            <img src="{{ asset('img/nv1.jpg') }}" alt="Cửa hàng">
                        </div>
                        <div class="carousel-item">
                            <img src="{{ asset('img/nv2.jpg') }}" alt="Cửa hàng">
                        </div>
                    </div>
