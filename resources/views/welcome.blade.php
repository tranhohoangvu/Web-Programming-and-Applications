            ...
            <nav class="navbar navbar-expand-lg custom-navbar py-3">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav ms-auto">
                        <li class="nav-item">
                            <a class="nav-link text-white" href="{{ route('information.member') }}">Giới thiệu</a>
                        </li>
                        <!-- <li class="nav-item">
    ...
    <div class="container">
        <div class="row">
            <!-- <div class="col-md-12 banner">
                <img  src="{{ asset('img/banner.webp') }}"alt="Banner Image" class="img-fluid banner">
            </div> -->
            <div class="col-md-12 banner">
                <div id="imageCarousel" class="carousel slide" data-bs-ride="carousel">
                    <div class="carousel-inner">
                        ...
                        <div class="carousel-item">
                            <img src="{{ asset('img/banner1.jpeg') }}" alt="Cửa hàng">
                        </div>
                        <div class="carousel-item">
                            <img src="{{ asset('img/banner2.png') }}" alt="Cửa hàng">
                        </div>
                        <div class="carousel-item">
                            <img src="{{ asset('img/banner3.png') }}" alt="Cửa hàng">
                        </div>
                    </div>
        ...
        <div id="products" class="mb-3">
            <div class="row">
                <div class="col-md-3">
                    <div class="card">
                        <img class="product-img" src="{{ asset('img/ip15.jpg') }}" alt="Product 1" >
                        <div class="card-body">
                ...
                <div class="col-md-3">
                    <div class="card">
                        <img class="product-img" src="{{ asset('img/ss.png') }}" alt="Product 1">
                        <div class="card-body">
                ...
                <div class="col-md-3">
                    <div class="card">
                        <img class="product-img" src="{{ asset('img/xiaomi.jpg') }}" alt="Product 3" >
                        <div class="card-body">
                ...
                <div class="col-md-3">
                    <div class="card">
                        <img class="product-img" src="{{ asset('img/oppo.jpg') }}" alt="Product 4" >
                        <div class="card-body">
